...
@section('title', 'Crear Registro de Inventario')

@section('content_header')
    <h1><i class="fas fa-plus-circle"></i> Crear Nuevo Registro de Inventario</h1>
@endsection

@section('content')
<div class="card shadow">
    <div class="card-header bg-gradient-success">
        <h3 class="card-title text-white"><i class="fas fa-warehouse"></i> Información del Inventario</h3>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="producto_nombre" id="producto_nombre" class="form-control @error('producto_nombre') is-invalid @enderror" 
                               value="{{ old('producto_nombre') }}" required placeholder="Ingrese el nombre del producto">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="cantidad" id="cantidad" class="form-control @error('cantidad') is-invalid @enderror" 
                               value="{{ old('cantidad') }}" required min="0" placeholder="0">
                        @error('cantidad')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="peso" id="peso" class="form-control @error('peso') is-invalid @enderror" 
                               value="{{ old('peso') }}" step="0.01" min="0" placeholder="0.00">
                        @error('peso')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="precio_unitario" id="precio_unitario" class="form-control @error('precio_unitario') is-invalid @enderror" 
                               value="{{ old('precio_unitario') }}" step="0.01" min="0" placeholder="0.00">
                    ...
                    <div class="form-group">
                        ...
                        <select name="envio_producto_id" id="envio_producto_id" class="form-control @error('envio_producto_id') is-invalid @enderror">
                            ...
                            @foreach($envioProductos as $envioProducto)
                                <option value="{{ $envioProducto->id }}" {{ old('envio_producto_id') == $envioProducto->id ? 'selected' : '' }}>
