...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-file-invoice-dollar text-success"></i> Notas de Entrega</h1>
        <span class="badge badge-success badge-pill" style="font-size: 1rem; padding: 10px 20px;">
            <i class="fas fa-receipt"></i> {{ count($notasEntrega) }} notas generadas
        </span>
    </div>
@stop
    ...
    <div class="card shadow-lg">
        <div class="card-header bg-gradient-success py-3">
            <h5 class="m-0 text-white">
                <i class="fas fa-list-alt"></i> Listado de Notas de Entrega
            </h5>
        </div>
        <div class="card-body">
            @if(count($notasEntrega) > 0)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('notas-entrega.show', $nota->id) }}" 
                                               class="btn btn-sm btn-info" 
                                               title="Ver detalles">
                                                <i class="fas fa-eye"></i> Ver
                                            </a>
                                            <a href="{{ route('notas-entrega.html', $nota->id) }}" 
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted">No hay notas de entrega generadas</h4>
