...
@section('title', 'Detalle Nota de Entrega')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-file-invoice-dollar text-success"></i> Nota de Entrega</h1>
        <a href="{{ route('notas-entrega.index') }}" class="btn btn-secondary">
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-footer bg-light">
                    <a href="{{ route('notas-entrega.html', $nota->id) }}" 
                       ...
                       target="_blank">
                        <i class="fas fa-print"></i> Imprimir Nota de Entrega
                    </a>
                </div>
            </div>
        </div>
