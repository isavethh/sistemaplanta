...
<div class="card shadow">
    <div class="card-header bg-gradient-primary">
        <h3 class="card-title text-white"><i class="fas fa-list"></i> Listado de Productos</h3>
    </div>
    <div class="card-body">
        <table id="productosTable" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ Str::limit($producto->descripcion ?? 'N/A', 50) }}</td>
                    <td>
                        @if($producto->precio_base)
                            <span class="text-success font-weight-bold">${{ number_format($producto->precio_base, 2) }}</span>
                        @else
